...
typedef void(^SDWebImageCompletionBlock)(NSObject *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL);

typedef void(^SDWebImageCompletionWithFinishedBlock)(NSObject *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL);
 ...
 */
- (NSObject *)imageManager:(SDWebImageManager *)imageManager transformDownloadedImage:(NSObject *)image withURL:(NSURL *)imageURL;
